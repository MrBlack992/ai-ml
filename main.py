...
# img=PhotoImage(file="Images_png/PM_Modi.png")
...
def button2_click():
    ...
    #get latest video added
    list_of_files = glob.glob(f"{pathlib.Path().resolve()}/Videos/*.mp4")  # * means all if need specific format then *.csv
